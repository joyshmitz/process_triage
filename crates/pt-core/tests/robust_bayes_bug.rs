use pt_core::inference::robust::{best_case_expected_loss, worst_case_expected_loss, CredalSet};
...
fn test_robust_bayes_constraints_bug() {
    ...
    let credals = [CredalSet::interval(0.0, 1.0), CredalSet::interval(0.5, 1.0)];
...
fn test_best_case_constraints_bug() {
    ...
    let credals = [CredalSet::interval(0.5, 1.0), CredalSet::interval(0.0, 1.0)];
